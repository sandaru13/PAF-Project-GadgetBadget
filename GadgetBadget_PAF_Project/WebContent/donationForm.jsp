  ...
  <body>
    ...
    <form>
      ...
      <fieldset>
	      ...
	      <input id="amount" type="number"   name="amount" placeholder="USD $"/>
	      </div>
	      <div class="item">
	      <label for="donation">Comments</label>
      ...
      <fieldset>
       <legend>Donation Form</legend>
        <div class="colums">
          ...
          <img src="images/cards.jpg" alt="credit/debit cards" width="450" height="65">
          <div class="item">
            <label for="cname">Card Number<span>*</span></label>
            <input id="cname" type="text" name="cname" placeholder ="xxxx xxxx xxxx xxxx" max="16"/>
          </div>
        
          	<div class="item">
            <label for="date">Expiration Date On The Card<span>*</span></label>
			<input id="expdate" type="text" name="expdate" placeholder="12 / 2025" >
          	</div>
