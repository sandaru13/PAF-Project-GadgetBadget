...
<body>
    	...
    	<!-- header -->
	    <header>
	        <div class="overlay"  style="background-image: url('https://mdbootstrap.com/img/new/slides/005.jpg');"></div>
	        <div class="container h-100">
	            <div class="d-flex h-100 text-center align-items-center">
	                <div class="w-100 text-white">
	                    <h1 class="display-3" style="font-weight: bolder;">Help an Innovator</h1>
	                    <h3 class="lead mt-3">Your fund will make their project Successful.</h3><br>
	                </div>
	            </div>
	        </div>
	    </header>
